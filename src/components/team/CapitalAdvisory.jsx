...
const CapitalAdvisory = () => {
    return (
        <div className='py-12 md:py-24    border-t  border-black/50 mt-12 md:mt-24 space-y-5 md:space-y-16'>
            <SectionHeading
            ...
            />
            <div className="container text-black grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="   border border-black/10 items-stretch gap-x-5 rounded-xl flex p-4  md:p-8">
                    <div className="rounded-lg aspect-3/4 w-[35%]   overflow-hidden">
                        <div data-clip-effect className="w-full   h-full">
                            <img className='cover' src="/images/team/akshi.png" alt="img" />
                        </div>
                    </div>
                    <div className="w-[65%] flex flex-col justify-between">
                        <div className="">
                            <h4 className='capitalize md:font-semibold leading-none'>Akshi Goyal</h4>
                ...
                <div className="  border  border-black/10 items-stretch gap-x-5 rounded-xl flex p-4  md:p-8">
                    <div className="rounded-lg aspect-3/4 w-[35%]   overflow-hidden">
                        <div data-clip-effect className="w-full  h-full">
                            <img className='cover' src="/images/team/ankur.png" alt="img" />
                        </div>
                    </div>
                    <div className="w-[65%] flex flex-col justify-between">
                        <div className="">
                            <h4 className='capitalize md:font-semibold leading-none'>Ankur Goyal</h4>
