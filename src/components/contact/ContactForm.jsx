                    ...
                    <div className=" md:pr-32 space-y-5">
                        ...
                        <div className=" w-full   space-y-4 ">
                            {foundersData.map((item, index) => (
                                ...
                                >
                                    <div className="absolute bg-[#7B78E7] group-hover:h-full w-full z-[-1] left-0 h-0 bottom-0 transition-all duration-300"></div>
                                    ...
                                    <div className={`size-10 center rounded-full border border-black/10 group-hover:bg-[#ffffff] group-hover:text-[#29227d] transition-all duration-300`}>
